...
import { ExecutionResult, NoteAndSlot } from './interfaces/index.js';
...
export class AppCircuitResult {
    constructor(
        ...
        public readonly nestedExecutions: AppCircuitResult[],
    ...
    /**
     * Convert an AppCircuitResult to an ExecutionResult usable by the Kernel Circuit Prover
     ...
     * @returns - the execution result with some fields removed (i.e. AppCircuitResult)
     */
    public static fromExecutionResult(result: ExecutionResult): AppCircuitResult {
        return new AppCircuitResult(
            result.vk,
            result.callStackItem,
            result.readRequestPartialWitnesses,
            result.newNotes,
            result.nestedExecutions.map(ne => AppCircuitResult.fromExecutionResult(ne)),
    ...
    public static fromJSON(obj: any): AppCircuitResult {
        return new AppCircuitResult(
            ...
            obj.nestedExecutions.map((ne: any) => AppCircuitResult.fromJSON(ne)),
